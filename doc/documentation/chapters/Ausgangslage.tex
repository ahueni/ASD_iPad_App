...
Das geologische Institut der Universität Zürich betreibt zur Forschung vier Spektrometer der Firma ASD Inc. aus Colorado in den USA. Zu jedem Spektrometer liefert ASD einen Notebook mit installierter Software um das  \gls{spectrometer} zu bedienen und Messungen auszuführen.

Ziel dieser Arbeit war es die Software \href{https://www.asdi.com/products-and-services/software/rs3}{RS\textsuperscript{3}} von ASD mit einer modernen Applikation für ein mobiles Device abzulösen. Das Projektteam hat sich gemeinsam mit dem Kunden dazu entschieden die Applikation für iOS Geräte, im speziellen iPads, zu entwickeln.
