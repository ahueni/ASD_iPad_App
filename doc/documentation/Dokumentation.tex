...
\documentclass[a4paper,oneside,abstract,listof=numbered,bibliography=totocnumbered]{scrreprt}
...
\newcommand{\autorA}{Andreas Lüscher}
...
% page style for empty pages like tilepage
...
\parskip 10pt			% 10pt Abstand zwischen den einzelnen Absätzen
...
% Testing
\input{chapters/Projektorganisation}

% Fazit
\input{chapters/Fazit}

% Ehrlichkeitserklärung
\input{chapters/Ehrlichkeitserklaerung}
