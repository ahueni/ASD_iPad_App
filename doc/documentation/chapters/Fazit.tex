...
Weiter können in Swift keine abstrakten Klassen definiert werden, so können externe Entwickler versehentlich vergessen Methoden zu überschreiben. Dies wurde gelöst, indem in den Basismethoden welche abgeleitet werden müssen ein Fatal Error geworfen wird.
