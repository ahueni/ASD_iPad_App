...
Als Dark Current wird das Spektrum bezeichnet, das gemessen wurde, nachdem dem Spektrometer komplett das Licht genommen wurde. Dies erreicht man auf unterschiedliche Weise. Eine Möglichkeit ist das Kappen der \gls{faser} oder das Schliessen des mechanischen Shutter. Es gibt bei neueren Geräten eine weitere Möglichkeit die Dark Correction mit einer im voraus geladenen Konfigurationsdatei auszuführen. Im aktuellen Projekt wird nur die Variante mit dem mechanischen Shutter unterstützt.
...
\newline
Die erwähnte Radianzberechnung befindet sich in der Methode \verb= convert_DN2L=.
